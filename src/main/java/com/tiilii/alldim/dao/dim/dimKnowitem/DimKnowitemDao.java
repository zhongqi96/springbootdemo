 ...
 *	注意：DimKnowitemDao.java不是开源产品，任何未经许可的源码修改、重新发布、反编译，都会被追究法律责任
 *
 */

package com.tiilii.alldim.dao.dim.dimKnowitem;
...
@Repository
public class DimKnowitemDao extends TemplateDao<DimKnowitem> {
